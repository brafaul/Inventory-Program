...
\item User needs to be able to modify their inventory.
\end{itemize}

\subsubsection{Non-Functional}
\begin{itemize}
\item Security -- each user should only be allowed to access their account with the proper username and password
\item Login --  each user should have unique username and password
\end{itemize}
...
\item[Use Case Name:] Remove Item
\item[Description:] A user wants to remove an item from his or her inventory
\end{itemize}


\begin{enumerate}
\item User logins to his or her account
\item User navigates to the remove window
\item User enters in the name of the item he or she would like to remove and hits enter
\item User inventory is updated to reflect the removal of said item.
\item[Termination Outcome:] The user no longer has the requested item stored in his or her inventory.
\end{enumerate}
...
\item[Use Case Name:]Add Item
\item[Description:] A user wants to add an item to his or her inventory
\end{itemize}

\begin{enumerate}
\item User logs in to his or her account 
\item User navigates to the add window
\item User enters in the name, amount, id of the item they wish to add, and hit enter
\item User's inventory is updated to reflect the added item
\item[Termination Outcome:] The user's inventory now contains the requested item
...
\begin{enumerate}
\item Uer logs in to his or her account
...
Design: The design of the program, including interface mockups and UML's was completed by March 15. \\ \indent
Implementation: The program all front end functionality by April 15. The back end functionality, loading data from and writing data to the databases, was functional by April 25.  \\ \indent
Verification: We verified that the program was working as intended on April 25.
Maintenance: The program underwent maintenance from April 25 to April 29.
